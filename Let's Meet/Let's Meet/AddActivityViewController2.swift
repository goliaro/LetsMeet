...
class AddActivityViewController2: UIViewController {
    ...
    @IBAction func startButtonPressed(_ sender: UIButton) {
        /* let activity = Activity(name: activityName!, starting_time: activityStartingTimePicker.date, ending_time: activityEndingTimePicker.date, description: activityDescription!, location: activityLocation!, participants_usernames: []) */
